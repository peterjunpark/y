...
CREATE TABLE "Like" (
    ...
    CONSTRAINT "userId_postId" PRIMARY KEY ("likerId","likedPostId")
);
...
CREATE TABLE "User" (
    ...
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "handle" VARCHAR(12),
    "membership" "MembershipEnum" NOT NULL DEFAULT 'standard',
...
-- CreateIndex
CREATE INDEX "postId_idx" ON "Like"("likedPostId");

-- CreateIndex
CREATE INDEX "authorId_idx" ON "Post"("authorId");
